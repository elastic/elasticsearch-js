...
export default class Connector {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-check-in | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-delete | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-get | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-last-sync | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-list | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-put | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-cancel | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-check-in | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-claim | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-delete | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-error | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-get | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-list | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-post | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-sync-job-update-stats | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-filtering | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-api-key-id | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-configuration | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-error | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-features | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-filtering-validation | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-index-name | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-name | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-native | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-pipeline | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-scheduling | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-service-type | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-connector-update-status | Elasticsearch API documentation}
    */
