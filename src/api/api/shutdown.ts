...
export default class Shutdown {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/master/delete-shutdown.html | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/master/get-shutdown.html | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/master/put-shutdown.html | Elasticsearch API documentation}
    */
