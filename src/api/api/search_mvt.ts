...
/**
  ...
  * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-search-mvt | Elasticsearch API documentation}
  */
...
export default async function SearchMvtApi (this: That, params: T.SearchMvtRequest, options?: TransportRequestOptions): Promise<any> {
  ...
  const meta: TransportRequestMetadata = {
    ...
    acceptedParams: {
      path: ['index', 'field', 'zoom', 'x', 'y'],
      body: ['aggs', 'buffer', 'exact_bounds', 'extent', 'fields', 'grid_agg', 'grid_precision', 'grid_type', 'query', 'runtime_mappings', 'size', 'sort', 'track_total_hits', 'with_labels'],
      query: ['exact_bounds', 'extent', 'grid_agg', 'grid_precision', 'grid_type', 'project_routing', 'size', 'track_total_hits', 'with_labels']
    }
  }
