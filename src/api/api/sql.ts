...
export default class Sql {
  ...
  async query (this: That, params?: T.SqlQueryRequest, options?: TransportRequestOptions): Promise<any> {
    ...
    const meta: TransportRequestMetadata = {
      ...
      acceptedParams: {
        path: [],
        body: ['allow_partial_search_results', 'catalog', 'columnar', 'cursor', 'fetch_size', 'field_multi_value_leniency', 'filter', 'index_using_frozen', 'keep_alive', 'keep_on_completion', 'page_timeout', 'params', 'query', 'request_timeout', 'runtime_mappings', 'time_zone', 'wait_for_completion_timeout'],
        query: ['format', 'project_routing']
      }
    }
    return await this.transport.request({ path, method, querystring, body, meta }, options)
  }
