...
export default class Sql {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-clear-cursor | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-delete-async | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-get-async | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-get-async-status | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-query | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-translate | Elasticsearch API documentation}
    */
