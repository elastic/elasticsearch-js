...
export default class Nodes {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/clear-repositories-metering-archive-api.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/get-repositories-metering-api.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/cluster-nodes-hot-threads.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/cluster-nodes-info.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/secure-settings.html#reloadable-secure-settings Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/cluster-nodes-stats.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/cluster-nodes-usage.html Elasticsearch API docs}
    */
