...
export default async function CountApi (this: That, params?: T.CountRequest, options?: TransportRequestOptions): Promise<any> {
  ...
  const meta: TransportRequestMetadata = {
    ...
    acceptedParams: {
      path: ['index'],
      body: ['query'],
      query: ['allow_no_indices', 'analyzer', 'analyze_wildcard', 'default_operator', 'df', 'expand_wildcards', 'ignore_throttled', 'ignore_unavailable', 'lenient', 'min_score', 'preference', 'project_routing', 'routing', 'terminate_after', 'q']
    }
  }
