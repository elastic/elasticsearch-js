...
export default class Migration {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/migration-api-deprecation.html | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/migration-api-feature-upgrade.html | Elasticsearch API documentation}
    */
