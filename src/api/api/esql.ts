...
export default class Esql {
  ...
  async asyncQuery (this: That, params: T.EsqlAsyncQueryRequest, options?: TransportRequestOptions): Promise<any> {
    ...
    const meta: TransportRequestMetadata = {
      ...
      acceptedParams: {
        path: [],
        body: ['columnar', 'filter', 'locale', 'params', 'profile', 'query', 'tables', 'include_ccs_metadata', 'include_execution_metadata', 'wait_for_completion_timeout', 'keep_alive', 'keep_on_completion', 'project_routing'],
  ...
  async query (this: That, params: T.EsqlQueryRequest, options?: TransportRequestOptions): Promise<any> {
    ...
    const meta: TransportRequestMetadata = {
      ...
      acceptedParams: {
        path: [],
        body: ['columnar', 'filter', 'locale', 'params', 'profile', 'query', 'tables', 'include_ccs_metadata', 'include_execution_metadata', 'project_routing'],
