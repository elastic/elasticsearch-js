...
export default class AsyncSearch {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-async-search-submit | Elasticsearch API documentation}
    */
  ...
  async get<TDocument = unknown, TAggregations = Record<T.AggregateName, T.AggregationsAggregate>> (this: That, params: T.AsyncSearchGetRequest, options?: TransportRequestOptions): Promise<any> {
    ...
    const meta: TransportRequestMetadata = {
      ...
      acceptedParams: {
        path: ['id'],
        body: [],
        query: ['keep_alive', 'typed_keys', 'wait_for_completion_timeout', 'return_intermediate_results']
      }
    }
    return await this.transport.request({ path, method, querystring, body, meta }, options)
  }
