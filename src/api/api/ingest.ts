...
export default class Ingest {
  ...
  /**
    * Deletes a pipeline.
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/delete-pipeline-api.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/geoip-stats-api.html Elasticsearch API docs}
    */
  ...
  /**
    * Returns a pipeline.
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/get-pipeline-api.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/grok-processor.html#grok-processor-rest-get Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/put-pipeline-api.html Elasticsearch API docs}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/main/simulate-pipeline-api.html Elasticsearch API docs}
    */
