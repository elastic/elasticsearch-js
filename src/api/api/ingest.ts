...
export default class Ingest {
  ...
  /**
    * Deletes a pipeline.
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/delete-pipeline-api.html | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/geoip-stats-api.html | Elasticsearch API documentation}
    */
  ...
  /**
    * Returns a pipeline.
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/get-pipeline-api.html | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/grok-processor.html#grok-processor-rest-get | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/put-pipeline-api.html | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.8/simulate-pipeline-api.html | Elasticsearch API documentation}
    */
