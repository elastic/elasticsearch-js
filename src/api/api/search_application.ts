...
export default class SearchApplication {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-delete | Elasticsearch API documentation}
    */
  ...
  async delete (this: That, params: T.SearchApplicationDeleteRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      path: acceptedPath
    } = this[kAcceptedParams]['search_application.delete']
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-delete-behavioral-analytics | Elasticsearch API documentation}
    */
  ...
  async deleteBehavioralAnalytics (this: That, params: T.SearchApplicationDeleteBehavioralAnalyticsRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      path: acceptedPath
    } = this[kAcceptedParams]['search_application.delete_behavioral_analytics']
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-get | Elasticsearch API documentation}
    */
  ...
  async get (this: That, params: T.SearchApplicationGetRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      path: acceptedPath
    } = this[kAcceptedParams]['search_application.get']
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-get-behavioral-analytics | Elasticsearch API documentation}
    */
  ...
  async list (this: That, params?: T.SearchApplicationListRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      path: acceptedPath
    } = this[kAcceptedParams]['search_application.list']
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-post-behavioral-analytics-event | Elasticsearch API documentation}
    */
  ...
  async postBehavioralAnalyticsEvent (this: That, params: T.SearchApplicationPostBehavioralAnalyticsEventRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      ...
      body: acceptedBody,
      query: acceptedQuery
    } = this[kAcceptedParams]['search_application.post_behavioral_analytics_event']
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-put | Elasticsearch API documentation}
    */
  ...
  async put (this: That, params: T.SearchApplicationPutRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      ...
      body: acceptedBody,
      query: acceptedQuery
    } = this[kAcceptedParams]['search_application.put']
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-put-behavioral-analytics | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-render-query | Elasticsearch API documentation}
    */
  ...
  async renderQuery (this: That, params: T.SearchApplicationRenderQueryRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      ...
      body: acceptedBody,
      query: acceptedQuery
    } = this[kAcceptedParams]['search_application.render_query']
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-application-search | Elasticsearch API documentation}
    */
  ...
  async search<TDocument = unknown, TAggregations = Record<T.AggregateName, T.AggregationsAggregate>> (this: That, params: T.SearchApplicationSearchRequest, options?: TransportRequestOptions): Promise<any> {
    const {
      ...
      body: acceptedBody,
      query: acceptedQuery
    } = this[kAcceptedParams]['search_application.search']
