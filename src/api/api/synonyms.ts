...
export default class Synonyms {
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-synonyms-delete-synonym | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-synonyms-delete-synonym-rule | Elasticsearch API documentation}
    */
  ...
  /**
    * Get a synonym set.
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-synonyms-get-synonym | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-synonyms-get-synonym-rule | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-synonyms-put-synonym | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-synonyms-put-synonym-rule | Elasticsearch API documentation}
    */
