...
export default class TextStructure {
  ...
  async findFieldStructure (this: That, params: T.TextStructureFindFieldStructureRequest, options?: TransportRequestOptions): Promise<any> {
    ...
    const meta: TransportRequestMetadata = {
      ...
      acceptedParams: {
        path: [],
        body: [],
        query: ['column_names', 'delimiter', 'documents_to_sample', 'ecs_compatibility', 'explain', 'field', 'format', 'grok_pattern', 'index', 'quote', 'should_trim_fields', 'should_parse_recursively', 'timeout', 'timestamp_field', 'timestamp_format']
      }
    }
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-text-structure-find-message-structure | Elasticsearch API documentation}
    */
  ...
  async findMessageStructure (this: That, params: T.TextStructureFindMessageStructureRequest, options?: TransportRequestOptions): Promise<any> {
    ...
    const meta: TransportRequestMetadata = {
      ...
      acceptedParams: {
        path: [],
        body: ['messages'],
        query: ['column_names', 'delimiter', 'ecs_compatibility', 'explain', 'format', 'grok_pattern', 'quote', 'should_trim_fields', 'should_parse_recursively', 'timeout', 'timestamp_field', 'timestamp_format']
      }
    }
    return await this.transport.request({ path, method, querystring, body, meta }, options)
  }
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-text-structure-find-structure | Elasticsearch API documentation}
    */
  ...
  async findStructure<TJsonDocument = unknown> (this: That, params: T.TextStructureFindStructureRequest<TJsonDocument>, options?: TransportRequestOptions): Promise<any> {
    ...
    const meta: TransportRequestMetadata = {
      ...
      acceptedParams: {
        path: [],
        body: ['text_files'],
        query: ['charset', 'column_names', 'delimiter', 'ecs_compatibility', 'explain', 'format', 'grok_pattern', 'has_header_row', 'line_merge_size_limit', 'lines_to_sample', 'quote', 'should_trim_fields', 'should_parse_recursively', 'timeout', 'timestamp_field', 'timestamp_format']
      }
    }
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-text-structure-test-grok-pattern | Elasticsearch API documentation}
    */
