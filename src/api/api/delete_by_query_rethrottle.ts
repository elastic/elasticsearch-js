...
/**
  ...
  * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.x/docs-delete-by-query.html#docs-delete-by-query-rethrottle | Elasticsearch API documentation}
  */
