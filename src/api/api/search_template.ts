...
export default async function SearchTemplateApi<TDocument = unknown> (this: That, params?: T.SearchTemplateRequest, options?: TransportRequestOptions): Promise<any> {
  ...
  const meta: TransportRequestMetadata = {
    ...
    acceptedParams: {
      path: ['index'],
      body: ['explain', 'id', 'params', 'profile', 'source'],
      query: ['allow_no_indices', 'ccs_minimize_roundtrips', 'expand_wildcards', 'explain', 'ignore_throttled', 'ignore_unavailable', 'preference', 'profile', 'project_routing', 'routing', 'scroll', 'search_type', 'rest_total_hits_as_int', 'typed_keys']
    }
  }
