...
export default class Transform {
  ...
  /**
    * Delete a transform.
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-delete-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-get-node-stats | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-get-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-get-transform-stats | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-preview-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-put-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-reset-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-schedule-now-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-set-upgrade-mode | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-start-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-stop-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-update-transform | Elasticsearch API documentation}
    */
  ...
  /**
    ...
    * @see {@link https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-transform-upgrade-transforms | Elasticsearch API documentation}
    */
