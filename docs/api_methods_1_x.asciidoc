...
* <<api-count-1-x,count>>
* <<api-countpercolate-1-x,countPercolate>>
* <<api-create-1-x,create>>
* <<api-delete-1-x,delete>>
* <<api-deletebyquery-1-x,deleteByQuery>>
* <<api-exists-1-x,exists>>
* <<api-explain-1-x,explain>>
* <<api-get-1-x,get>>
...
* <<api-msearch-1-x,msearch>>
* <<api-mtermvectors-1-x,mtermvectors>>
* <<api-percolate-1-x,percolate>>
* <<api-ping-1-x,ping>>
...
* <<api-cat-health-1-x,cat.health>>
* <<api-cat-help-1-x,cat.help>>
* <<api-cat-indices-1-x,cat.indices>>
* <<api-cat-master-1-x,cat.master>>
* <<api-cat-nodes-1-x,cat.nodes>>
* <<api-cat-pendingtasks-1-x,cat.pendingTasks>>
* <<api-cat-plugins-1-x,cat.plugins>>
...
* <<api-cluster-putsettings-1-x,cluster.putSettings>>
* <<api-cluster-reroute-1-x,cluster.reroute>>
* <<api-cluster-state-1-x,cluster.state>>
* <<api-cluster-stats-1-x,cluster.stats>>
* <<api-indices-analyze-1-x,indices.analyze>>
* <<api-indices-clearcache-1-x,indices.clearCache>>
* <<api-indices-close-1-x,indices.close>>
* <<api-indices-create-1-x,indices.create>>
* <<api-indices-delete-1-x,indices.delete>>
* <<api-indices-deletealias-1-x,indices.deleteAlias>>
* <<api-indices-deletemapping-1-x,indices.deleteMapping>>
* <<api-indices-deletetemplate-1-x,indices.deleteTemplate>>
* <<api-indices-deletewarmer-1-x,indices.deleteWarmer>>
* <<api-indices-exists-1-x,indices.exists>>
* <<api-indices-existsalias-1-x,indices.existsAlias>>
* <<api-indices-existstemplate-1-x,indices.existsTemplate>>
* <<api-indices-existstype-1-x,indices.existsType>>
* <<api-indices-flush-1-x,indices.flush>>
* <<api-indices-getalias-1-x,indices.getAlias>>
* <<api-indices-getaliases-1-x,indices.getAliases>>
* <<api-indices-getfieldmapping-1-x,indices.getFieldMapping>>
* <<api-indices-getmapping-1-x,indices.getMapping>>
* <<api-indices-getsettings-1-x,indices.getSettings>>
* <<api-indices-gettemplate-1-x,indices.getTemplate>>
* <<api-indices-getwarmer-1-x,indices.getWarmer>>
* <<api-indices-open-1-x,indices.open>>
* <<api-indices-optimize-1-x,indices.optimize>>
* <<api-indices-putalias-1-x,indices.putAlias>>
* <<api-indices-putmapping-1-x,indices.putMapping>>
...
* <<api-indices-validatequery-1-x,indices.validateQuery>>
* <<api-nodes-hotthreads-1-x,nodes.hotThreads>>
* <<api-nodes-info-1-x,nodes.info>>
* <<api-nodes-shutdown-1-x,nodes.shutdown>>
* <<api-nodes-stats-1-x,nodes.stats>>
* <<api-snapshot-create-1-x,snapshot.create>>
* <<api-snapshot-createrepository-1-x,snapshot.createRepository>>
* <<api-snapshot-delete-1-x,snapshot.delete>>
* <<api-snapshot-deleterepository-1-x,snapshot.deleteRepository>>
* <<api-snapshot-get-1-x,snapshot.get>>
* <<api-snapshot-getrepository-1-x,snapshot.getRepository>>
...
[[api-indices-deletetemplate-1-x]]
...
[[api-indices-existstemplate-1-x]]
...
[[api-indices-getfieldmapping-1-x]]
...
[[api-snapshot-createrepository-1-x]]
...
[[api-snapshot-deleterepository-1-x]]
...
[[api-snapshot-getrepository-1-x]]
