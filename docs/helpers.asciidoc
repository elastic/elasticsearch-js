...
CAUTION: If you are using the client with Node.js v8 you should run your code with the `--harmony-async-iteration` argument. +
eg: `node index.js --harmony-async-iteration`
