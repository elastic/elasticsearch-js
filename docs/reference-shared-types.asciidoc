...
type AggregationsAdjacencyMatrixBucket = AggregationsAdjacencyMatrixBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | string | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsBoxPlotAggregate extends <<AggregationsAggregateBase>> {
  ...
  q2: <<_double, double>>
  q3: <<_double, double>>
  lower: <<_double, double>>
  upper: <<_double, double>>
...
interface AggregationsCardinalityAggregation extends <<AggregationsMetricAggregationBase>> {
  ...
  precision_threshold?: <<_integer, integer>>
  rehash?: boolean
...
interface AggregationsCategorizeTextAggregation {
  ...
  max_unique_tokens?: <<_integer, integer>>
  ...
  max_matched_tokens?: <<_integer, integer>>
  ...
  similarity_threshold?: <<_integer, integer>>
  ...
  min_doc_count?: <<_integer, integer>>
  ...
  shard_min_doc_count?: <<_integer, integer>>
}
[pass]
++++
</pre>
...
type AggregationsChildrenAggregate = AggregationsChildrenAggregateKeys
  & { [property: string]: <<AggregationsAggregate>> | <<_long, long>> | <<Metadata>> }
[pass]
++++
</pre>
++++
...
type AggregationsCompositeBucket = AggregationsCompositeBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<AggregationsCompositeAggregateKey>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
type AggregationsDateHistogramBucket = AggregationsDateHistogramBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | string | <<EpochTime>><<<UnitMillis>>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsDerivativeAggregate extends <<AggregationsSingleMetricAggregateBase>> {
  normalized_value?: <<_double, double>>
...
interface AggregationsDiversifiedSamplerAggregation extends <<AggregationsBucketAggregationBase>> {
  ...
  max_docs_per_value?: <<_integer, integer>>
  script?: <<Script>> | string
...
type AggregationsDoubleTermsBucket = AggregationsDoubleTermsBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<_double, double>> | string | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsExtendedStatsAggregate extends <<AggregationsStatsAggregate>> {
  sum_of_squares: <<_double, double>> | null
  variance: <<_double, double>> | null
  variance_population: <<_double, double>> | null
  variance_sampling: <<_double, double>> | null
  std_deviation: <<_double, double>> | null
  std_deviation_population: <<_double, double>> | null
  std_deviation_sampling: <<_double, double>> | null
...
<pre>
++++
type AggregationsFieldDateMath = <<DateMath>> | <<_double, double>>
[pass]
++++
</pre>
++++
...
type AggregationsFiltersBucket = AggregationsFiltersBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsFrequentItemSetsBucketKeys extends <<AggregationsMultiBucketBase>> {
  ...
  support: <<_double, double>>
}
type AggregationsFrequentItemSetsBucket = AggregationsFrequentItemSetsBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | Record<<<Field>>, string[]> | <<_double, double>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
type AggregationsGeoHashGridBucket = AggregationsGeoHashGridBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<GeoHash>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
type AggregationsGeoHexGridBucket = AggregationsGeoHexGridBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<GeoHexCell>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
type AggregationsGeoTileGridBucket = AggregationsGeoTileGridBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<GeoTile>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsHdrMethod {
  ...
  number_of_significant_value_digits?: <<_integer, integer>>
}
[pass]
++++
</pre>
...
interface AggregationsHistogramAggregation extends <<AggregationsBucketAggregationBase>> {
  pass:[/**] @property extended_bounds Enables extending the bounds of the histogram beyond the data itself. */
  extended_bounds?: <<AggregationsExtendedBounds>><<<_double, double>>>
  ...
  hard_bounds?: <<AggregationsExtendedBounds>><<<_double, double>>>
...
type AggregationsHistogramBucket = AggregationsHistogramBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | string | <<_double, double>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsInferenceTopClassEntry {
  ...
  class_probability: <<_double, double>>
  class_score: <<_double, double>>
}
[pass]
++++
</pre>
...
interface AggregationsIpPrefixAggregation extends <<AggregationsBucketAggregationBase>> {
  ...
  prefix_length: <<_integer, integer>>
...
type AggregationsIpPrefixBucket = AggregationsIpPrefixBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | boolean | string | <<_integer, integer>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
<pre>
++++
type AggregationsKeyedPercentiles = Record<string, string | <<_long, long>> | null>
[pass]
++++
</pre>
++++
...
type AggregationsLongRareTermsBucket = AggregationsLongRareTermsBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<_long, long>> | string }
[pass]
++++
</pre>
++++
...
interface AggregationsMatrixAggregation {
  ...
  fields?: <<Fields>>
  pass:[/**] @property missing The value to apply to documents that do not have a value. By default, documents without a value are ignored. */
  missing?: Record<<<Field>>, <<_double, double>>>
}
[pass]
++++
</pre>
...
interface AggregationsMatrixStatsFields {
  ...
  count: <<_long, long>>
  mean: <<_double, double>>
  variance: <<_double, double>>
  skewness: <<_double, double>>
  kurtosis: <<_double, double>>
  covariance: Record<<<Field>>, <<_double, double>>>
  correlation: Record<<<Field>>, <<_double, double>>>
}
[pass]
++++
</pre>
...
<pre>
++++
type AggregationsMissing = string | <<_integer, integer>> | <<_double, double>> | boolean
[pass]
++++
</pre>
++++
...
interface AggregationsMovingAverageAggregationBase extends <<AggregationsPipelineAggregationBase>> {
  minimize?: boolean
  predict?: <<_integer, integer>>
  window?: <<_integer, integer>>
}
[pass]
++++
</pre>
...
interface AggregationsMultiTermsAggregation extends <<AggregationsBucketAggregationBase>> {
  ...
  shard_min_doc_count?: <<_long, long>>
...
interface AggregationsMultiTermsBucketKeys extends <<AggregationsMultiBucketBase>> {
  key: <<FieldValue>>[]
  key_as_string?: string
  doc_count_error_upper_bound?: <<_long, long>>
}
type AggregationsMultiTermsBucket = AggregationsMultiTermsBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<FieldValue>>[] | string | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsSerialDifferencingAggregation extends <<AggregationsPipelineAggregationBase>> {
  pass:[/**] @property lag The historical bucket to subtract from the current value. Must be a positive, non-zero <<_integer, integer>>. */
  lag?: <<_integer, integer>>
}
[pass]
++++
</pre>
...
type AggregationsSignificantLongTermsBucket = AggregationsSignificantLongTermsBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<_long, long>> | string | <<_double, double>> }
[pass]
++++
</pre>
++++
...
interface AggregationsStandardDeviationBounds {
  upper: <<_double, double>> | null
  lower: <<_double, double>> | null
  upper_population: <<_double, double>> | null
  lower_population: <<_double, double>> | null
  upper_sampling: <<_double, double>> | null
  lower_sampling: <<_double, double>> | null
}
[pass]
++++
</pre>
...
interface AggregationsStatsAggregate extends <<AggregationsAggregateBase>> {
  count: <<_long, long>>
  min: <<_double, double>> | null
  max: <<_double, double>> | null
  avg: <<_double, double>> | null
  sum: <<_double, double>>
  min_as_string?: string
  max_as_string?: string
...
interface AggregationsStringStatsAggregate extends <<AggregationsAggregateBase>> {
  count: <<_long, long>>
  min_length: <<_integer, integer>> | null
  max_length: <<_integer, integer>> | null
  avg_length: <<_double, double>> | null
  entropy: <<_double, double>> | null
  distribution?: Record<string, <<_double, double>>> | null
...
type AggregationsStringTermsBucket = AggregationsStringTermsBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | <<FieldValue>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
interface AggregationsTermsAggregateBase<TBucket = unknown> extends <<AggregationsMultiBucketAggregateBase>><TBucket> {
  doc_count_error_upper_bound?: <<_long, long>>
  sum_other_doc_count?: <<_long, long>>
}
[pass]
++++
</pre>
...
type AggregationsTimeSeriesBucket = AggregationsTimeSeriesBucketKeys
  & { [property: string]: <<AggregationsAggregate>> | Record<<<Field>>, <<FieldValue>>> | <<_long, long>> }
[pass]
++++
</pre>
++++
...
<pre>
++++
type AggregationsValueType = 'string' | '<<_long, long>>' | '<<_double, double>>' | 'number' | 'date' | 'date_nanos' | 'ip' | 'numeric' | 'geo_point' | 'boolean'
[pass]
++++
</pre>
++++
...
interface AggregationsVariableWidthHistogramAggregation {
  ...
  initial_buffer?: <<_integer, integer>>
  script?: <<Script>> | string
}
[pass]
++++
...
interface AnalysisCharGroupTokenizer extends <<AnalysisTokenizerBase>> {
  ...
  max_token_length?: <<_integer, integer>>
}
[pass]
++++
</pre>
...
interface AnalysisCompoundWordTokenFilterBase extends <<AnalysisTokenFilterBase>> {
  ...
  max_subword_size?: <<_integer, integer>>
  min_subword_size?: <<_integer, integer>>
  min_word_size?: <<_integer, integer>>
...
interface AnalysisCustomAnalyzer {
  ...
  position_increment_gap?: <<_integer, integer>>
  position_offset_gap?: <<_integer, integer>>
  tokenizer: string
}
[pass]
++++
...
<pre>
++++
type AnalysisDelimitedPayloadEncoding = 'int' | '<<_float, float>>' | 'identity'
[pass]
++++
</pre>
++++
...
interface AnalysisEdgeNGramTokenFilter extends <<AnalysisTokenFilterBase>> {
  type: 'edge_ngram'
  max_gram?: <<_integer, integer>>
  min_gram?: <<_integer, integer>>
...
interface AnalysisFingerprintAnalyzer {
  type: 'fingerprint'
  version?: <<VersionString>>
  max_output_size: <<_integer, integer>>
...
interface AnalysisKuromojiStemmerTokenFilter extends <<AnalysisTokenFilterBase>> {
  ...
  minimum_length: <<_integer, integer>>
}
[pass]
++++
</pre>
...
interface AnalysisLimitTokenCountTokenFilter extends <<AnalysisTokenFilterBase>> {
  ...
  max_token_count?: <<SpecUtilsStringified>><<<_integer, integer>>>
}
[pass]
++++
</pre>
...
interface AnalysisPathHierarchyTokenizer extends <<AnalysisTokenizerBase>> {
  type: 'path_hierarchy'
  buffer_size?: <<SpecUtilsStringified>><<<_integer, integer>>>
  delimiter?: string
  replacement?: string
  reverse?: <<SpecUtilsStringified>><boolean>
  skip?: <<SpecUtilsStringified>><<<_integer, integer>>>
}
[pass]
++++
</pre>
...
interface AnalysisShingleTokenFilter extends <<AnalysisTokenFilterBase>> {
  type: 'shingle'
  filler_token?: string
  max_shingle_size?: <<_integer, integer>> | string
  min_shingle_size?: <<_integer, integer>> | string
...
interface MappingCompletionProperty extends <<MappingDocValuesPropertyBase>> {
  ...
  max_input_length?: <<_integer, integer>>
...
interface MappingDateNanosProperty extends <<MappingDocValuesPropertyBase>> {
  ...
  index?: boolean
  null_value?: <<DateTime>>
  precision_step?: <<_integer, integer>>
  type: 'date_nanos'
}
[pass]
++++
...
interface MappingDenseVectorIndexOptions {
  type: string
  m?: <<_integer, integer>>
  ef_construction?: <<_integer, integer>>
  confidence_interval?: <<_float, float>>
}
[pass]
++++
</pre>
...
interface MappingRuntimeField {
  ...
  script?: <<Script>> | string
  pass:[/**] @property type <<Field>> type, which can be: `boolean`, `composite`, `date`, `<<_double, double>>`, `geo_point`, `ip`,`keyword`, `<<_long, long>>`, or `lookup`. */
  type: <<MappingRuntimeFieldType>>
}
[pass]
++++
...
<pre>
++++
type MappingRuntimeFieldType = 'boolean' | 'composite' | 'date' | '<<_double, double>>' | 'geo_point' | 'ip' | 'keyword' | '<<_long, long>>' | 'lookup'
[pass]
++++
</pre>
++++
...
interface MappingSearchAsYouTypeProperty extends <<MappingCorePropertyBase>> {
  ...
  index?: boolean
  index_options?: <<MappingIndexOptions>>
  max_shingle_size?: <<_integer, integer>>
  norms?: boolean
  search_analyzer?: string
  search_quote_analyzer?: string
  similarity?: string | null
...
interface MappingSuggestContext {
  ...
  path?: <<Field>>
  type: string
  precision?: <<_integer, integer>> | string
}
[pass]
++++
</pre>
...
interface MappingTextIndexPrefixes {
  max_chars: <<_integer, integer>>
  min_chars: <<_integer, integer>>
}
[pass]
++++
</pre>
...
interface QueryDslCommonTermsQuery extends <<QueryDslQueryBase>> {
  analyzer?: string
  cutoff_frequency?: <<_double, double>>
...
interface QueryDslFuzzyQuery extends <<QueryDslQueryBase>> {
  ...
  max_expansions?: <<_integer, integer>>
  ...
  value: string | <<_double, double>> | boolean
}
[pass]
++++
</pre>
...
type QueryDslGeoBoundingBoxQuery = QueryDslGeoBoundingBoxQueryKeys
  & { [property: string]: <<GeoBounds>> | <<QueryDslGeoExecution>> | <<QueryDslGeoValidationMethod>> | boolean | <<_float, float>> | string }
[pass]
++++
</pre>
++++
...
type QueryDslGeoDistanceQuery = QueryDslGeoDistanceQueryKeys
  & { [property: string]: <<GeoLocation>> | <<Distance>> | <<GeoDistanceType>> | <<QueryDslGeoValidationMethod>> | boolean | <<_float, float>> | string }
[pass]
++++
</pre>
++++
...
type QueryDslGeoPolygonQuery = QueryDslGeoPolygonQueryKeys
  & { [property: string]: <<QueryDslGeoPolygonPoints>> | <<QueryDslGeoValidationMethod>> | boolean | <<_float, float>> | string }
[pass]
++++
</pre>
++++
...
type QueryDslGeoShapeQuery = QueryDslGeoShapeQueryKeys
  & { [property: string]: <<QueryDslGeoShapeFieldQuery>> | boolean | <<_float, float>> | string }
[pass]
++++
</pre>
++++
...
interface QueryDslMatchQuery extends <<QueryDslQueryBase>> {
  ...
  query: string | <<_float, float>> | boolean
  pass:[/**] @property zero_terms_query Indicates whether no documents are returned if the `analyzer` removes all tokens, such as when using a `stop` filter. */
  zero_terms_query?: <<QueryDslZeroTermsQuery>>
}
[pass]
...
<pre>
++++
interface QueryDslNumberRangeQuery extends <<QueryDslRangeQueryBase>><<<_double, double>>> {
}
[pass]
++++
</pre>
...
<pre>
++++
interface QueryDslNumericDecayFunctionKeys extends <<QueryDslDecayFunctionBase>><<<_double, double>>, <<_double, double>>> {
}
...
interface QueryDslQueryContainer {
  ...
  fuzzy?: Partial<Record<<<Field>>, <<QueryDslFuzzyQuery>> | string | <<_double, double>> | boolean>>
  ...
  match?: Partial<Record<<<Field>>, <<QueryDslMatchQuery>> | string | <<_float, float>> | boolean>>
...
type QueryDslShapeQuery = QueryDslShapeQueryKeys
  & { [property: string]: <<QueryDslShapeFieldQuery>> | boolean | <<_float, float>> | string }
[pass]
++++
</pre>
++++
...
<pre>
++++
type QueryDslSpanGapQuery = Partial<Record<<<Field>>, <<_integer, integer>>>>
[pass]
++++
</pre>
++++
...
interface QueryDslSpanQuery {
  ...
  span_term?: Partial<Record<<<Field>>, <<QueryDslSpanTermQuery>> | string>>
  pass:[/**] @property span_within The result from a single span query is returned as <<_long, long>> is its span falls within the spans returned by a list of other span queries. */
  span_within?: <<QueryDslSpanWithinQuery>>
}
[pass]
++++
...
interface QueryDslSparseVectorQuery extends <<QueryDslQueryBase>> {
  ...
  query_vector?: Record<string, <<_float, float>>>
...
type QueryDslTermsQuery = QueryDslTermsQueryKeys
  & { [property: string]: <<QueryDslTermsQueryField>> | <<_float, float>> | string }
[pass]
++++
</pre>
++++
...
interface QueryDslTokenPruningConfig {
  ...
  tokens_freq_ratio_threshold?: <<_integer, integer>>
  ...
  tokens_weight_threshold?: <<_float, float>>
...
interface QueryDslWeightedTokensQuery extends <<QueryDslQueryBase>> {
  ...
  tokens: Record<string, <<_float, float>>>
  pass:[/**] @property pruning_config Token pruning configurations */
  pruning_config?: <<QueryDslTokenPruningConfig>>
}
[pass]
