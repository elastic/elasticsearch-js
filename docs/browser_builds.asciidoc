...
=== Download
 * v10.1.0-snapshot: https://download.elasticsearch.org/elasticsearch/elasticsearch-js/elasticsearch-js-10.1.0-snapshot.zip[zip], https://download.elasticsearch.org/elasticsearch/elasticsearch-js/elasticsearch-js-10.1.0-snapshot.tar.gz[tar.gz]
