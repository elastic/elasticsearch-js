...
While there is https://github.com/elastic/elasticsearch-js/issues/96#issuecomment-42617480[a way to get it working in IE 9], the browser severely limits what you can do with cross-domain requests. Because of these limits, many of the API calls and other functionality do not work.
...
=== Download
 * v3.1.3: https://download.elastic.co/elasticsearch/elasticsearch-js/elasticsearch-js-3.1.3.zip[zip], https://download.elastic.co/elasticsearch/elasticsearch-js/elasticsearch-js-3.1.3.tar.gz[tar.gz]
