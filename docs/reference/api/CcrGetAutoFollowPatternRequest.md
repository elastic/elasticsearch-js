# `CcrGetAutoFollowPatternRequest` [interface-CcrGetAutoFollowPatternRequest]
...
| `name` | [Name](./Name.md) | The auto-follow pattern collection that you want to retrieve. If you do not specify a name, the API returns information for all collections. |
