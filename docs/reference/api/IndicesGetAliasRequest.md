# `IndicesGetAliasRequest` [interface-IndicesGetAliasRequest]
...
| `name` | [Names](./Names.md) | Comma-separated list of aliases to retrieve. Supports wildcards ( `*`). To retrieve all aliases, omit this parameter or use `*` or `_all`. |
