...
| `max_unique_tokens?` | [`integer`](integer.md) | The maximum number of unique tokens at any position up to max_matched_tokens. Must be larger than 1.
...
| `max_matched_tokens?` | [`integer`](integer.md) | The maximum number of token positions to match on before attempting to merge categories. Larger
