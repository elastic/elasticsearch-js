...
|----------|------|-------------|
| `delay?` | [`Duration`](Duration.md) | How long to wait before rolling up new documents.
...
| `time_zone?` | [`TimeZone`](TimeZone.md) | Defines what `time_zone` the rollup documents are stored as.
