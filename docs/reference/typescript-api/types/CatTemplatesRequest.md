...
|----------|------|-------------|
| `name?` | [`Name`](Name.md) | The name of the template to return.
Accepts wildcard expressions. If omitted, all templates are returned. |
| `h?` | [`CatCatTemplatesColumns`](CatCatTemplatesColumns.md) | A comma-separated list of columns names to display. It supports simple wildcards. |
