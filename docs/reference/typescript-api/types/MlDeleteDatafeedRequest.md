...
|----------|------|-------------|
| `datafeed_id` | [`Id`](Id.md) | A numerical character string that uniquely identifies the datafeed. This
identifier can contain lowercase alphanumeric characters (a-z and 0-9),
hyphens, and underscores. It must start and end with alphanumeric
characters. |
| `force?` | `boolean` | Use to forcefully delete a started datafeed; this method is quicker than
