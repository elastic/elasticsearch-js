...
| `extended_bounds?` | [`AggregationsExtendedBounds`](AggregationsExtendedBounds.md)<AggregationsFieldDateMath> | Enables extending the bounds of the histogram beyond the data itself. |
| `hard_bounds?` | [`AggregationsExtendedBounds`](AggregationsExtendedBounds.md)<AggregationsFieldDateMath> | Limits the histogram to specified bounds. |
