...
|----------|------|-------------|
| `date_histogram?` | [`RollupDateHistogramGrouping`](RollupDateHistogramGrouping.md) | A date histogram group aggregates a date field into time-based buckets.
...
| `terms?` | [`RollupTermsGrouping`](RollupTermsGrouping.md) | The terms group can be used on keyword or numeric fields to allow bucketing via the terms aggregation at a later point.
