...
| `cluster_state_update?` | `Record<string, NodesClusterStateUpdate>` | Contains low-level statistics about how long various activities took during cluster state updates while the node was the elected master.
