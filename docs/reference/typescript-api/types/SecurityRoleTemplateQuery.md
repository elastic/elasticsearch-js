...
|----------|------|-------------|
| `template?` | `SecurityRoleTemplateScript | SecurityRoleTemplateInlineQuery` | When you create a role, you can specify a query that defines the document level security permissions. You can optionally
