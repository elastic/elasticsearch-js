...
| `body?` | `string | { [key: string]: any } & { datafeed_id?: never, allow_no_match?: never, h?: never, s?: never }` | All values in `body` will be added to the request body. |
| `querystring?` | `{ [key: string]: any } & { datafeed_id?: never, allow_no_match?: never, h?: never, s?: never }` | All values in `querystring` will be added to the request querystring. |
