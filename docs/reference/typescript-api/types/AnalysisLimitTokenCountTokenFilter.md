...
| `max_token_count?` | [`SpecUtilsStringified`](SpecUtilsStringified.md)<integer> | Maximum number of tokens to keep. Once this limit is reached, any remaining tokens are excluded from the output. Defaults to `1`. |
