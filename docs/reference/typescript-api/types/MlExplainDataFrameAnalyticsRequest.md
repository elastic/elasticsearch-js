...
| `source?` | [`MlDataframeAnalyticsSource`](MlDataframeAnalyticsSource.md) | The configuration of how to source the analysis data. It requires an
index. Optionally, query and _source may be specified. |
| `dest?` | [`MlDataframeAnalyticsDestination`](MlDataframeAnalyticsDestination.md) | The destination configuration, consisting of index and optionally
