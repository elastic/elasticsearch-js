...
| `prefix_length` | `integer` | Length of the network prefix. For IPv4 addresses the accepted range is [0, 32].
...
| `min_doc_count?` | `long` | Minimum number of documents in a bucket for it to be included in the response. |
