...
|----------|------|-------------|
| `bytes_read` | [`long`](long.md) | The total of transferred bytes read from the leader.
...
| `follower_global_checkpoint` | [`long`](long.md) | The current global checkpoint on the follower.
...
| `time_since_last_read_millis` | [`DurationValue`](DurationValue.md)<UnitMillis> | The number of milliseconds since a read request was sent to the leader.
...
| `total_read_remote_exec_time_millis` | [`DurationValue`](DurationValue.md)<UnitMillis> | The total time reads spent running on the remote cluster. |
| `total_read_time?` | [`Duration`](Duration.md) | - |
| `total_read_time_millis` | [`DurationValue`](DurationValue.md)<UnitMillis> | The total time reads were outstanding, measured from the time a read was sent to the leader to the time a reply was returned to the follower. |
| `total_write_time?` | [`Duration`](Duration.md) | - |
| `total_write_time_millis` | [`DurationValue`](DurationValue.md)<UnitMillis> | The total time spent writing on the follower. |
