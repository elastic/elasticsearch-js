# InferenceVoyageAIServiceSettings
...
|----------|------|-------------|
| `dimensions?` | [`integer`](integer.md) | The number of dimensions for resulting output embeddings.
...
| `rate_limit?` | [`InferenceRateLimitSetting`](InferenceRateLimitSetting.md) | This setting helps to minimize the number of rate limit errors returned from VoyageAI.
...
| `embedding_type?` | [`float`](float.md) | The data type for the embeddings to be returned.
