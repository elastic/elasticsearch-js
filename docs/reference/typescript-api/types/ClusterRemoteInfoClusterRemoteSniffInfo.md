...
| `max_connections_per_cluster` | `integer` | The maximum number of connections maintained for the remote cluster when sniff mode is configured. |
| `num_nodes_connected` | `long` | The number of connected nodes in the remote cluster when sniff mode is configured. |
