...
|----------|------|-------------|
| `origin` | [`TOrigin`](TOrigin.md) | Date or point of origin used to calculate distances.
...
| `pivot` | [`TDistance`](TDistance.md) | Distance from the `origin` at which relevance scores receive half of the `boost` value.
...
| `field` | [`Field`](Field.md) | Name of the field used to calculate distances. This field must meet the following criteria:
