...
|----------|------|-------------|
| `origin` | `TOrigin` | Date or point of origin used to calculate distances.
...
| `pivot` | `TDistance` | Distance from the `origin` at which relevance scores receive half of the `boost` value.
