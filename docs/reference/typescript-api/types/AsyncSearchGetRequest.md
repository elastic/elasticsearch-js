...
| `keep_alive?` | [`Duration`](Duration.md) | The length of time that the async search should be available in the cluster.
...
| `wait_for_completion_timeout?` | [`Duration`](Duration.md) | Specifies to wait for the search to be completed up until the provided timeout.
