...
| `index_options?` | [`MappingDenseVectorIndexOptions`](MappingDenseVectorIndexOptions.md) | An optional section that configures the kNN indexing algorithm. The HNSW algorithm has two internal parameters
...
| `similarity?` | [`MappingDenseVectorSimilarity`](MappingDenseVectorSimilarity.md) | The vector similarity metric to use in kNN search.
