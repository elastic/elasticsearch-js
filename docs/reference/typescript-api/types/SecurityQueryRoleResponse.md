...
|----------|------|-------------|
| `total` | `integer` | The total number of roles found. |
| `count` | `integer` | The number of roles returned in the response. |
| `roles` | `SecurityQueryRoleQueryRole[]` | A list of roles that match the query.
