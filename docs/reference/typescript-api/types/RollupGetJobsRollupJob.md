...
| `stats` | [`RollupGetJobsRollupJobStats`](RollupGetJobsRollupJobStats.md) | Transient statistics about the rollup job, such as how many documents have been processed and how many rollup summary docs have been indexed.
