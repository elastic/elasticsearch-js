...
| `retention_lease?` | [`IndicesRetentionLease`](IndicesRetentionLease.md) | The maximum period to retain a shard history retention lease before it is considered expired.
