...
|----------|------|-------------|
| `size?` | [`ByteSize`](ByteSize.md) | This controls the total size of translog files to keep for each shard. Keeping more translog files increases
...
| `age?` | [`Duration`](Duration.md) | This controls the maximum duration for which translog files are kept by each shard. Keeping more
