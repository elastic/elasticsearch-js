...
| `downsampling?` | [`IndicesDownsamplingRound`](IndicesDownsamplingRound.md)[] | The downsampling configuration to execute for the managed backing index after rollover. |
