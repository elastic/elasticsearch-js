...
| `time_throttled_nanos?` | [`DurationValue`](DurationValue.md)<UnitNanos> | The total amount of time, in nanoseconds, for which all tasks in the same cgroup as the Elasticsearch process have been throttled. |
