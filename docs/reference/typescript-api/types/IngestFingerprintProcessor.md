...
|----------|------|-------------|
| `fields` | [`Fields`](Fields.md) | Array of fields to include in the fingerprint. For objects, the processor
...
| `method?` | [`IngestFingerprintDigest`](IngestFingerprintDigest.md) | The hash method used to compute the fingerprint. Must be one of MD5, SHA-1,
SHA-256, SHA-512, or MurmurHash3. |
| `ignore_missing?` | `boolean` | If true, the processor ignores any missing fields. If all fields are
