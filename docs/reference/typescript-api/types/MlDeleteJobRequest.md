...
| `force?` | `boolean` | Use to forcefully delete an opened job; this method is quicker than
...
reset. |
| `wait_for_completion?` | `boolean` | Specifies whether the request should return immediately or wait until the
