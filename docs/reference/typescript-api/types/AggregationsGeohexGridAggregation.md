...
| `precision?` | `integer` | Integer zoom of the key used to defined cells or buckets
...
| `size?` | `integer` | Maximum number of buckets to return. |
| `shard_size?` | `integer` | Number of buckets returned from each shard. |
