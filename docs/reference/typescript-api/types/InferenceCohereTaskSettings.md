...
|----------|------|-------------|
| `input_type` | [`InferenceCohereInputType`](InferenceCohereInputType.md) | For a `text_embedding` task, the type of input passed to the model.
Valid values are:
