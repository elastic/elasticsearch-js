...
| `pipeline_metadata` | [`LogstashPipelineMetadata`](LogstashPipelineMetadata.md) | Optional metadata about the pipeline, which can have any contents.
This metadata is not generated or used by Elasticsearch or Logstash. |
| `pipeline_settings` | [`LogstashPipelineSettings`](LogstashPipelineSettings.md) | Settings for the pipeline.
