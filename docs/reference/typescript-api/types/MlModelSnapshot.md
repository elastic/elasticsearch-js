...
| `latest_record_time_stamp?` | `integer` | The timestamp of the latest processed record. |
| `latest_result_time_stamp?` | `integer` | The timestamp of the latest bucket result. |
...
| `timestamp` | `long` | The creation timestamp for the snapshot. |
