...
| `max_analyzed_offset?` | [`integer`](integer.md) | If set to a non-negative value, highlighting stops at this defined maximum limit.
...
| `number_of_fragments?` | [`integer`](integer.md) | The maximum number of fragments to return.
...
| `phrase_limit?` | [`integer`](integer.md) | Controls the number of matching phrases in a document that are considered.
