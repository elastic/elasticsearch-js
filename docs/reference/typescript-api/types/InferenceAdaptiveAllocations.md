...
| `max_number_of_allocations?` | [`integer`](integer.md) | The maximum number of allocations to scale to.
If set, it must be greater than or equal to `min_number_of_allocations`. |
| `min_number_of_allocations?` | [`integer`](integer.md) | The minimum number of allocations to scale to.
