# InferenceAzureAiStudioServiceSettings
...
|----------|------|-------------|
| `api_key` | `string` | A valid API key of your Azure AI Studio model deployment.
...
| `endpoint_type` | `string` | The type of endpoint that is available for deployment through Azure AI Studio: `token` or `realtime`.
...
| `target` | `string` | The target URL of your Azure AI Studio model deployment.
This can be found on the overview page for your deployment in the management section of your Azure AI Studio account. |
| `provider` | `string` | The model provider for your deployment.
...
| `rate_limit?` | [`InferenceRateLimitSetting`](InferenceRateLimitSetting.md) | This setting helps to minimize the number of rate limit errors returned from Azure AI Studio.
