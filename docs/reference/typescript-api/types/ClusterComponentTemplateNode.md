...
| `created_date_millis?` | `EpochTime<UnitMillis>` | Date and time when the component template was created, in milliseconds since the epoch. |
...
| `modified_date_millis?` | `EpochTime<UnitMillis>` | Date and time when the component template was last modified, in milliseconds since the epoch. |
