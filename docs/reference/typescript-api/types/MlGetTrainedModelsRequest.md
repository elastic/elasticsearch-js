...
|----------|------|-------------|
| `model_id?` | [`Ids`](Ids.md) | The unique identifier of the trained model or a model alias.
...
| `decompress_definition?` | `boolean` | Specifies whether the included model definition should be returned as a
