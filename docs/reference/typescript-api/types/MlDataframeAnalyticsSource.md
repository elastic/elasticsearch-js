...
| `_source?` | `MlDataframeAnalysisAnalyzedFields | string`[] | Specify `includes` and/or `excludes patterns to select which fields will be present in the destination. Fields that are excluded cannot be included in the analysis. |
