...
| `config?` | [`MlPreviewDataFrameAnalyticsDataframePreviewConfig`](MlPreviewDataFrameAnalyticsDataframePreviewConfig.md) | A data frame analytics config as described in create data frame analytics
