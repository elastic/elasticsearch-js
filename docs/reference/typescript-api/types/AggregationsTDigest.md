...
|----------|------|-------------|
| `compression?` | `integer` | Limits the maximum number of nodes used by the underlying TDigest algorithm to `20 * compression`, enabling control of memory usage and approximation error. |
