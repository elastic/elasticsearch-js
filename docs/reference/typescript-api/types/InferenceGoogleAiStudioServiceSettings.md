# InferenceGoogleAiStudioServiceSettings
...
| `rate_limit?` | [`InferenceRateLimitSetting`](InferenceRateLimitSetting.md) | This setting helps to minimize the number of rate limit errors returned from Google AI Studio.
