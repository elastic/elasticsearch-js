...
| `iteration` | `integer` | The number of iterations on the analysis. |
| `timestamp` | `EpochTime<UnitMillis>` | The timestamp when the statistics were reported in milliseconds since the epoch. |
