...
| `max_outstanding_read_requests?` | `integer` | The maximum number of outstanding reads requests from the remote cluster. |
...
| `max_outstanding_write_requests?` | `integer` | The maximum number of outstanding reads requests from the remote cluster. |
...
| `max_read_request_operation_count?` | `integer` | The maximum number of operations to pull per read from the remote cluster. |
...
| `max_write_buffer_count?` | `integer` | The maximum number of operations that can be queued for writing. When this limit is reached, reads from the remote cluster will be deferred until the number of queued operations goes below the limit. |
...
| `max_write_request_operation_count?` | `integer` | The maximum number of operations per bulk write request executed on the follower. |
