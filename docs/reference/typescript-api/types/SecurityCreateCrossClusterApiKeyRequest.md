...
| `expiration?` | [`Duration`](Duration.md) | Expiration time for the API key.
...
| `body?` | `string | { [key: string]: any } & { access?: never, expiration?: never, metadata?: never, name?: never, certificate_identity?: never }` | All values in `body` will be added to the request body. |
| `querystring?` | `{ [key: string]: any } & { access?: never, expiration?: never, metadata?: never, name?: never, certificate_identity?: never }` | All values in `querystring` will be added to the request querystring. |
