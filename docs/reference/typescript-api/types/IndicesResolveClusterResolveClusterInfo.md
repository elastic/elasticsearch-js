...
| `matching_indices?` | `boolean` | Whether the index expression provided in the request matches any indices, aliases or data streams
on the cluster. |
| `error?` | `string` | Provides error messages that are likely to occur if you do a search with this index expression
