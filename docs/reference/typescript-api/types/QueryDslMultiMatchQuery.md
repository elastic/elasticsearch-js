...
| `fields?` | [`Fields`](Fields.md) | The fields to be queried.
...
| `tie_breaker?` | `double` | Determines how scores for each per-term blended query and scores across groups are combined. |
