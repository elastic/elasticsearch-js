...
```typescript
client.simulate.ingest(this: That, params: T.SimulateIngestRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.SimulateIngestResponse>
```
...
|-----------|------|-------------|
| `this` | `That` | - |
| `params` | [`SimulateIngestRequest`](../types/SimulateIngestRequest.md) | - |
| `options?` | `TransportRequestOptionsWithOutMeta` | - |

### Returns

`Promise<T.SimulateIngestResponse>`
