...
function Tasks (transport) {
  this.transport = transport
}

Tasks.prototype.cancel = function tasksCancelApi (params, options, callback) {
  options = options || {}
...
Tasks.prototype.get = function tasksGetApi (params, options, callback) {
  options = options || {}
  if (typeof options === 'function') {
    callback = options
    options = {}
...
Tasks.prototype.list = function tasksListApi (params, options, callback) {
  options = options || {}
  if (typeof options === 'function') {
    callback = options
    options = {}
