...
function buildMlRevertModelSnapshot (opts) {
  ...
  return function mlRevertModelSnapshot (params, options, callback) {
    ...
    path = '/' + '_ml' + '/' + 'anomaly_detectors' + '/' + encodeURIComponent(params['job_id'] || params['jobId']) + '/' + 'model_snapshots' + '/' + encodeURIComponent(params['snapshot_id'] || params['snapshotId']) + '/' + '_revert'
