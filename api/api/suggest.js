...
function buildSuggest (opts) {
   ...
   * @param {object} body - The request definition
   */
  ...
  return function suggest (params, options, callback) {
    ...
    if (callback == null) {
      return new Promise((resolve, reject) => {
        suggest(params, options, (err, body) => {
    ...
    if ((index) != null) {
      path = '/' + encodeURIComponent(index) + '/' + '_suggest'
    } else {
      path = '/' + '_suggest'
    }
