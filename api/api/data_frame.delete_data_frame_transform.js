...
function buildDataFrameDeleteDataFrameTransform (opts) {
  ...
  /**
   * Perform a [data_frame.delete_data_frame_transform](TODO) request
   *
  ...
  return function dataFrameDeleteDataFrameTransform (params, options, callback) {
    ...
    if (callback == null) {
      return new Promise((resolve, reject) => {
        dataFrameDeleteDataFrameTransform(params, options, (err, body) => {
    ...
    if (params['transform_id'] == null && params['transformId'] == null) {
      return callback(
        new ConfigurationError('Missing required parameter: transform_id or transformId'),
        result
      )
    }
    if (params.body != null) {
