...
function buildMlUpdateModelSnapshot (opts) {
  ...
  return function mlUpdateModelSnapshot (params, options, callback) {
    ...
    path = '/' + '_ml' + '/' + 'anomaly_detectors' + '/' + encodeURIComponent(params['job_id'] || params['jobId']) + '/' + 'model_snapshots' + '/' + encodeURIComponent(params['snapshot_id'] || params['snapshotId']) + '/' + '_update'
