...
function buildXpackSecurityDisableUser (opts) {
  ...
  return function xpackSecurityDisableUser (params, options, callback) {
    options = options || {}
    ...
    if (callback == null) {
      return new Promise((resolve, reject) => {
        xpackSecurityDisableUser(params, options, (err, body) => {
    ...
    path = '/' + '_xpack' + '/' + 'security' + '/' + 'user' + '/' + encodeURIComponent(username) + '/' + '_disable'
